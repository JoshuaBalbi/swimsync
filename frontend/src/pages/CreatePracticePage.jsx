...
import AIPracticeGenerator from "../features/aiPractice/AIPracticeGenerator";
...
function CreatePracticeContent({ user }) {
  ...
  const [generatedPracticeData, setGeneratedPracticeData] = useState(null);
  ...
  function handleUseGeneratedPractice(data) {
    setGeneratedPracticeData(data);
    setActiveTab("ai");
  }
  ...
  return (
    <div className="min-vh-100 bg-light">
      ...
      <main className="container py-5">
        ...
        {activeTab === "ai" && (
          <AIPracticeGenerator
            onUseGeneratedPractice={handleUseGeneratedPractice}
          />
        )}
        ...
        <PracticeInfoForm
          ...
          mode={activeTab}
          externalGeneratedPractice={generatedPracticeData}
          saving={saving}
        />
      </main>
    </div>
...
//   const [profile, setProfile] = useState(null);
//   const [loading, setLoading] = useState(true);
//   const [generatedWorkoutText, setGeneratedWorkoutText] = useState("");
