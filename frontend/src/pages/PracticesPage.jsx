...
function PracticesContent({ user }) {
  ...
  const filteredPractices = practices.filter((practice) => {
    ...
    const isYourTeamPractice = isCoach
    ...
    return (
      ...
      (!filters.practiceTime ||
        (filters.practiceTime === "upcoming" && practiceDate >= today) ||
        (filters.practiceTime === "past" && practiceDate < today)) &&
      (filters.teamScope === "" ||
        (filters.teamScope === "your" && isYourTeamPractice) ||
      ...
      <main className="container py-5">
        ...
        {profile?.role === "swimmer" && (
          <div className="alert alert-info rounded-4">
            Approved swimmers can view team practices. Pending or independent
            swimmers can only view public practices.
          </div>
        )}
...
//       (filters.focus === "" || practice.focus === filters.focus) &&
//       (filters.practiceTime === "" ||
//         (filters.practiceTime === "upcoming" &&
//           new Date(practice.date) >= new Date(new Date().toDateString())) ||
//         (filters.practiceTime === "past" &&
//           new Date(practice.date) < new Date(new Date().toDateString()))) &&
//       (filters.teamScope === "" ||
//         (filters.teamScope === "your" && isYourTeamPractice) ||
//         (filters.teamScope === "other" && isOtherTeamPractice))
